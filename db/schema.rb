...
ActiveRecord::Schema.define(:version => 20120226151403) do
  ...
  add_index "journals", ["journal_model", "process_date", "patron_id"], :name => "index_journals_on_journal_model_and_process_date_and_patron_id", :unique => true
