...
ActiveRecord::Schema.define(:version => 20130629164002) do
  ...
  add_index "reminders", ["remindfor_type", "remindfor_id"], :name => "index_reminders_on_remindfor_type_and_remindfor_id"
  add_index "reminders", ["user_id", "patron_id"], :name => "index_reminders_on_user_id_and_patron_id"
